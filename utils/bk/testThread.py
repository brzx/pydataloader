...
class MyForm(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id = wx.ID_ANY, title = "www.OmegaXYZ.com", 
            pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL)
        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)
        gSizer2 = wx.GridSizer(0, 3, 0, 0)
        self.m_button2 = wx.Button(self, wx.ID_ANY, "execute thread", wx.DefaultPosition, wx.DefaultSize, 0)
    ...
    def onButton(self, event):
        TestThread()
        self.m_staticText2.SetLabel("thread start")
